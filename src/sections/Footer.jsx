  ...
  return(
    <footer className="relative overflow-hidden bg-black ">
      ...
      >
        ...
        >Deepanshu Choudhary</h1>
        <div className="h-[3px] w-24 md:w-100 rounded-full bg-linear-to-r from-[#0d58cc] via-cyan-300 to-emerald-400"/>
        ...
        <p className="text-gray-300 italic max-w-xl">"Strive for continuous improvement, not perfection."</p>
