...
const experiences = [{
  ...
  company: "CodeAlpha",
  duration: "2025",
  description: "Developed and maintained responsive web pages using modern frontend technologies.Learn about real-world project workflow and version control"
}, {
  role: "Dsa in cpp course",
  company: "Scalar",
  duration: "2025",
  description: "Practiced data structures and algorithms in C++.Solved numerous coding problems on platforms like LeetCode.Gained strong problem-solving and optimization skills."
}, {
  role: "Personal Projects",
  company: "None",
  duration: "2024 - Present",
  description: "Created various web applications using React, JavaScript, and CSS.Developed a Notes Web App, Image Gallery, and Calculator to enhance coding skills and portfolio."
}
];
  ...
  if(layout==="desktop"){
    return(
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        <motion.div className="z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(0,0,0,0.1)]"
        style={{scale,opacity}}
        >
        </motion.div>
        <motion.div className={`absolute ${idx%2===0?"-top-8":"-bottom-8"} w-[3px] `}
  ...
  return(
    <div className="relative flex items-start">
      ...
      >
        ...
        <p className="text-sm text-gray-400 wrap-break-word mb-2">
          {exp.company}|{exp.duration}
        </p>
              ...
              <div className="relative w-full max-w-7xl">
                ...
                <div className="relative flex justify-between mt-0 ">
                  {experiences.map((exp , idx)=>(
                    <ExperienceItems key={idx} exp={exp} idx={idx} start={idx===0?0 : thresholds[idx-1]} end={thresholds[idx]} scrollYProgress={scrollYProgress} layout="desktop"/>
                  ))}
            ...
            {isMobile &&(
              <div className="relative w-full max-w-md">
                ...
                <div className="relative flex flex-col gap-10 ml-10 mt-6 pb-28">
                  {experiences.map((exp , idx)=>(
                    <ExperienceItems key={idx} exp={exp} idx={idx} start={idx===0?0 : thresholds[idx-1]} end={thresholds[idx]} scrollYProgress={scrollYProgress} layout="mobile"/>
                  ))}
